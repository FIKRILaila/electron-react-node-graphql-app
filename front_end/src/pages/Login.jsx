            ...
            <div className="bg-white shadow-lg rounded-md px-8 py-8 mb-4 ml-auto mr-auto">
              <div className="mb-4">
                <label className="block text-gray-700 text-sm font-medium mb-2" htmlFor="username"> Email
                  address </label>
                <input className="shadow-sm appearance-none border border-gray-300 rounded w-full py-4 px-3 text-gray-700 text-sm leading-tight focus:outline-none focus:border-cyan-300" id="username" type="text" placeholder="user@example.com"/>
              </div>
              <div className="mb-6">
              ...
              <div className="mb-6">
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div className="text-center sm:text-right">
                    <a href="#" className="text-cyan-400 font-medium text-sm duration-200 transition-colors hover:text-cyan-500">Forgot
                      your password?</a>
                  </div>
                </div>
              </div>
              ...
              <div className='mb-6'>
                <p className="text-center text-gray-500 text-sm"> don't have an account? <Link to="/register" className='text-cyan-400'>Sign up</Link> </p>
              </div>
